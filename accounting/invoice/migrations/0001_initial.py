...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0002_auto_20171224_1657'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_text', models.TextField(blank=True, help_text='Any arbitrary extra text that the provider would like to display on their invoice. Each template has a designated location to place this extra text.', null=True)),
                ('signature', models.TextField(blank=True, help_text="The provider's signature.", max_length=100, null=True)),
                ('template', models.CharField(choices=[('default', 'Default')], default='default', help_text='The template to use to generate this invoice.', max_length=80)),
                ...
                ('auto_pdf_on_save', models.BooleanField(default=False, help_text='Whether this invoice should be converted to a PDF on save.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('line_item_id', models.IntegerField(help_text='A non-auto-incrementing ID used for line items with the same fields for when the items may be the same or different. For example: a line item may have the exact same descriptive fields but still be a separate physical item, in which case a UUID or auto-incrementing ID would not suffice to tell the difference.')),
                ('key', models.CharField(help_text='The key identifier for this line item. For example: OC-9999.', max_length=100)),
                ('name', models.CharField(help_text='What the item is.', max_length=255)),
