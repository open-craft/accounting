    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.CharField(default=accounting.invoice.models.default_invoice_number, help_text='The unique invoice number. Defaults to yyyy-mm for the current year and month.', max_length=80)),
                ...
                ('billing_start_date', models.DateTimeField(default=accounting.common.utils.get_first_day_past_month, help_text='The first date for which the line items in this invoice were provided. Defaults to the first day of the past month.')),
                ('billing_end_date', models.DateTimeField(default=accounting.common.utils.get_last_day_past_month, help_text='The last date for which the line items in this invoice were provided. Defaults to the last day of the past month.')),
                ('due_date', models.DateTimeField(default=accounting.common.utils.get_day_with_offset, help_text='When this invoice should be paid.')),
